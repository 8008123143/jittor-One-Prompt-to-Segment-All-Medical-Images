"""
Configuration argument parser for One-Prompt (Jittor version).
"""
...
def parse_args():
    ...
    parser.add_argument('-vis', type=int, default=None, help='visualization frequency')
    parser.add_argument('-reverse', type=bool, default=False, help='adversary reverse')
    parser.add_argument('-pretrain', type=bool, default=False, help='use pretrained')
    ...
    parser.add_argument('-base_weights', type=str, default=0, help='weights baseline')
    parser.add_argument('-sim_weights', type=str, default=0, help='weights sim')
