"""
Model builder factory for One-Prompt (Jittor version).
Builds ViT-H, ViT-L, ViT-B, and U-Net variants.
"""
...
def build_one_vit_h(args=None, checkpoint=None):
    """Build One-Prompt with ViT-H backbone."""
    return _build_one(
        args,
...
def build_one_vit_l(args=None, checkpoint=None):
    """Build One-Prompt with ViT-L backbone."""
    return _build_one(
        args,
...
def build_one_vit_b(args=None, checkpoint=None):
    """Build One-Prompt with ViT-B backbone."""
    return _build_one(
        args,
...
def build_one_unet(args=None, checkpoint=None):
    """Build One-Prompt with U-Net backbone."""
    return _build_one(
        args,
...
# Model registry (mirrors PyTorch version)
one_model_registry = {
...
def _build_one(
    ...
    """Core builder for One-Prompt model."""
    ...
    # Set to eval mode by default (matching original behavior)
    model.eval()
